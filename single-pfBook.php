...
<footer class="pf-book">
    <div class="footer">
        <div class="prev-project">
            <a href="<?php echo home_url('/Cebu-IT-Abroad');?>" alt="prev" class="pagenav-btn">
            ...
            <a class="work-left" href="<?php echo home_url('/Cebu-IT-Abroad');?>" alt="prev" onmouseover="mouseOn();" onmouseout="mouseOut();"><span>PREV PROJECT</span></a>
        </div>
        <div class="footer-work"><a class="work-link" href="<?php echo home_url(); ?>/work"><span>Work</span></a></div>
        <div class="next-project">
            <a class="work-right" href="<?php echo home_url('/First-class');?>" alt="next" onmouseover="mouseOnR();" onmouseout="mouseOutR();"><span>NEXT PROJECT</span></a>
            <a href="<?php echo home_url('/First-class');?>" alt="next" class="pagenav-btn">
