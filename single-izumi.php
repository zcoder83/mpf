<?php
/*
 * Template Name: Work Izumi
 * Template Post Type: post, page, product
 */
get_header();
?>
<div class="izumi-content">
    ...
    <div class="pf-img"><img src="<?php bloginfo('template_url'); ?>/img/izumi.jpg" alt=""></div>
    <div class="work-img">
        <div class="work-wrapper">
            <img src="<?php bloginfo('template_url'); ?>/img/izumi-work.png" alt="izumi-work">
        </div>
    </div>
</div>
<footer class="ft-izumi">
    <div class="footer">
        <div class="prev-project">
            <a href="<?php echo home_url('/tamakuchen');?>" alt="prev" class="pagenav-btn">
            ...
            <a class="work-left" href="<?php echo home_url('/tamakuchen');?>" alt="prev" onmouseover="mouseOn();" onmouseout="mouseOut();"><span>PREV PROJECT</span></a>
        </div>
        <div class="footer-work"><a class="work-link" href="<?php echo home_url(); ?>/work"><span>Work</span></a></div>
        <div class="next-project">
            <a class="work-right" href="<?php echo home_url('/Cebu-IT-Abroad');?>" alt="next" onmouseover="mouseOnR();" onmouseout="mouseOutR();"><span>NEXT PROJECT</span></a>
            <a href="<?php echo home_url('/Cebu-IT-Abroad');?>" alt="next" class="pagenav-btn">
