...
<footer class="ft-tamakuchen">
    <div class="footer">
        <div class="prev-project">
            <a href="<?php echo home_url('/Nisshin');?>" alt="prev" class="pagenav-btn">
                <img class="left-1" id="left-1" onmouseover="mouseOn();" src="<?php bloginfo('template_url'); ?>/img/prev.png" alt="prev-btn">
                <img class="left-2" id="left-2" onmouseout="mouseOut();" src="<?php bloginfo('template_url'); ?>/img/prev.png" alt="prev-btn">
            </a>
            <a class="work-left" href="<?php echo home_url('/Nisshin');?>" alt="prev" onmouseover="mouseOn();" onmouseout="mouseOut();"><span>PREV PROJECT</span></a>
        </div>
        <div class="footer-work"><a class="work-link" href="<?php echo home_url(); ?>/work"><span>Work</span></a></div>
        <div class="next-project">
            <a class="work-right" href="<?php echo home_url('/izumi');?>" alt="next" onmouseover="mouseOnR();" onmouseout="mouseOutR();"><span>NEXT PROJECT</span></a>
            <a href="<?php echo home_url('/izumi');?>" alt="next" class="pagenav-btn">
